...
function addRow() {
  ...
  newInputRow.innerHTML = `
    <form>
        ...
        <label for="name" class="label">Ime elementa:</label>
        <input type="text" class="name valueInput" placeholder="Unesi ime:">

        <label for="length" class="label">Duzina (mm):</label>
        <input type="number" class="length valueInput" placeholder="Unesi duzinu:">
        <label for="width" class="label">Sirina (mm):</label>
        <input type="number" class="width valueInput" placeholder="Unesi sirinu:">
        <label for="result" class="label">Povrsina (m2)</label>
        <input type="number" class="result valueInput" disabled>
        <label for="lengthSide" class="label">Kant po duzini:</label>
        <input type="checkbox" class="lengthSideCheckbox">
        <input type="checkbox" class="lengthSideCheckbox">
        <label for="widthSide" class="label">Kant po sirini:</label>
        <input type="checkbox" class="widthSideCheckbox">
        <input type="checkbox" class="widthSideCheckbox">
        <label for="sideProcessing" class="label">Duzina kantovanja (m):</label>
...
function openAdditionaServicesPage() {
  window.open('additionalServices.html', '_blank');
}
